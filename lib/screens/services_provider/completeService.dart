...
class CompleteServiceProvider extends StatefulWidget {
  ...
  CompleteServiceProvider(
      ...
      required this.id});
  @override
  State<CompleteServiceProvider> createState() => _CompleteOrderState();
}

class _CompleteOrderState extends State<CompleteServiceProvider> {
